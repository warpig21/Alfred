...
class AppFlowyDefaultTheme implements AppFlowyThemeBuilder {
  ...
  AppFlowyThemeData light({
    ...
    final textColorScheme = AppFlowyTextColorScheme(
      ...
      action: Color(0xFFFF5B34),
      actionHover: Color(0xFFE7451B),
      info: Color(0xFF006FD8),
      infoHover: Color(0xFF005EB9),
      success: Color(0xFF009A46),
      successHover: Color(0xFF00853C),
      warning: Color(0xFFF9AD26),
      warningHover: Color(0xFFE39A00),
      error: Color(0xFFE40016),
      errorHover: Color(0xFFC60012),
    ...
    final iconColorScheme = AppFlowyIconColorScheme(
      ...
      quaternary: AppFlowyPrimitiveTokens.neutral200,
      infoThick: Color(0xFF006FD8),
      infoThickHover: Color(0xFF005EB9),
      successThick: Color(0xFF009A46),
      successThickHover: Color(0xFF00853C),
      warningThick: Color(0xFFF9AD26),
      warningThickHover: Color(0xFFE39A00),
      errorThick: Color(0xFFE40016),
      errorThickHover: Color(0xFFC60012),
    ...
    final borderColorScheme = AppFlowyBorderColorScheme(
      ...
      themeThick: Color(0xFFFF5B34),
      themeThickHover: Color(0xFFE7451B),
      infoThick: Color(0xFF006FD8),
      infoThickHover: Color(0xFF005EB9),
      successThick: Color(0xFF009A46),
      successThickHover: Color(0xFF00853C),
    ...
    final fillColorScheme = AppFlowyFillColorScheme(
      ...
      themeThick: Color(0xFFFF5B34),
      themeThickHover: Color(0xFFE7451B),
      themeSelect: Color(0x26FF5B34),
      textSelect: Color(0x33FF5B34),
    ...
    final otherColorsColorScheme = AppFlowyOtherColorsColorScheme(
      textHighlight: Color(0xFFFFE9E3),
    );
  ...
  AppFlowyThemeData dark({
    ...
    final textColorScheme = AppFlowyTextColorScheme(
      ...
      onFill: AppFlowyPrimitiveTokens.neutralWhite,
      action: Color(0xFFFF5B34),
      actionHover: Color(0xFFFF8C71),
      info: Color(0xFF53A0FF),
      infoHover: Color(0xFF79B4FF),
      success: Color(0xFF03A14A),
      successHover: Color(0xFF2EB45C),
      warning: Color(0xFFF9AD26),
      warningHover: Color(0xFFFFC673),
      error: Color(0xFFFF6568),
      errorHover: Color(0xFFFF8987),
      featured: AppFlowyPrimitiveTokens.purple500,
    ...
    final iconColorScheme = AppFlowyIconColorScheme(
      ...
      tertiary: AppFlowyPrimitiveTokens.neutral600,
      quaternary: AppFlowyPrimitiveTokens.neutral1000,
      infoThick: Color(0xFF53A0FF),
      infoThickHover: Color(0xFF79B4FF),
      successThick: Color(0xFF03A14A),
      successThickHover: Color(0xFF2EB45C),
      warningThick: Color(0xFFF9AD26),
      warningThickHover: Color(0xFFFFC673),
      errorThick: Color(0xFFFF6568),
      errorThickHover: Color(0xFFFF8987),
      featuredThick: AppFlowyPrimitiveTokens.purple500,
    ...
    final borderColorScheme = AppFlowyBorderColorScheme(
      ...
      themeThick: Color(0xFFFF5B34),
      themeThickHover: Color(0xFFFF8C71),
      infoThick: Color(0xFF53A0FF),
      infoThickHover: Color(0xFF79B4FF),
      successThick: Color(0xFF03A14A),
      successThickHover: Color(0xFF2EB45C),
